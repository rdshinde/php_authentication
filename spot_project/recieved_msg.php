...
?>
        ...
        <div class="p-3 p-lg-2 bg-light rounded-3">
            <h1 class="display-5 text-center mb-5">Messages Received</h1>
            <div class="m-1 m-lg-1">
                ...
                <div
                    ...
                    ">
                    <?php
                    $srollno = $_SESSION["rollno"];
                    $sql = "SELECT * FROM messages WHERE rollno=$srollno";
                    ...
                    if($resultCheck > 0){
                      while($row = mysqli_fetch_assoc($results)){
                        ...
                        <div class="card mb-3" style="width: 25rem;">
                            <div class="card-body">
                                <h5 class="card-title h5"> From: '.$name.'</h5>
